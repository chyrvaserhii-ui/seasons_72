...
SCENES = {
    ...
    21: "Hokusai-style PAINTING of three SHORT SQUAT young EARTH SPROUTS, each sprout is ONLY 25 cm tall, shaped like a fat artichoke or a giant pinecone, wrapped in horizontal bands of brown-and-cream overlapping LEAF SCALES, fat at the base and tapering to a sharp pointed tip, half-buried in dark forest soil with brown leaf litter, May spring growth, the sprouts are SOLID and CLOSED, the sprouts are SHORT (knee-height only), the sprouts DO NOT have any green leaves, DO NOT have stalks, DO NOT extend into trees, ground-level woodblock view, flat color fields with bold ink outlines on aged washi paper, painterly NOT photographic, soft misty empty background with NO trees, NO tall plants, NO bamboo of any kind, NO grove, NO green growth above the sprouts, just three small wrapped pointed cones sitting in dark earth like artichokes, traditional Japanese woodblock print",
